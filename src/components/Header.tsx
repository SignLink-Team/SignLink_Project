...
import { Hand, HelpCircle, LogIn, LogOut, User, Save, SaveAll } from 'lucide-react';
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-white border-b border-neutral-100 shadow-xs px-4 md:px-8 py-4">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div 
          onClick={onLogoClick}
          className="flex items-center gap-3 cursor-pointer group select-none self-start"
        >
          <motion.div 
          ...
          >
            <img 
              src="/src/assets/images/signlink_icon_1780075452377.png" 
              alt="SignLink Logo" 
          ...
          <motion.button
            ...
            onClick={() => {
              if (user.isLoggedIn) {
                ...
                alert('자동 저장 기능은 자격이 확인된 의료진 로그인 시에만 사용 및 EMR 전송이 가능합니다.');
              }
            }}
